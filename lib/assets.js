...
(function() {
  ...
  module.exports = exports = function(options) {
    var connectAssets, _base, _base1, _ref, _ref1, _ref10, _ref2, _ref3, _ref4, _ref5, _ref6, _ref7, _ref8, _ref9;
    if (options == null) {
      options = {};
    }
    if (connectAssets) {
    ...
    if ((_ref = options.helperContext) == null) {
      options.helperContext = global;
    }
    if (process.env.NODE_ENV === 'production') {
      if ((_ref1 = options.build) == null) {
        options.build = true;
      }
      if ((_ref2 = (_base = cssCompilers.styl).compress) == null) {
        _base.compress = true;
      }
      if ((_ref3 = (_base1 = cssCompilers.less).compress) == null) {
        _base1.compress = true;
      }
      if ((_ref4 = options.servePath) == null) {
        options.servePath = '';
      }
    } else {
      options.servePath = '';
    ...
    if ((_ref10 = options.pathsOnly) == null) {
  ...
  ConnectAssets = (function() {
    ...
    function ConnectAssets(options) {
      ...
      this.absPath = __bind(this.absPath, this);
